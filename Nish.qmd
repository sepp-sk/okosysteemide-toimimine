...
\[cite_start\]Ökoloogilise niši mõiste ei ole ajaloos olnud ühtne, vaid see on välja arenenud kahe erineva rõhuasetusega koolkonna kaudu, mis tänapäeval moodustavad "niši kaks külge"\[cite: 52\].

\[cite_start\]**Joseph Grinnell (1917, 1927)** käsitles nišši eelkõige läbi linnuliikide toitumis- ja pesapaigavajaduste ning muude kohastumuste, mis määravad tema koha koosluses\[cite: 42\]. \[cite_start\]Grinnelli definitsioon, mida nimetatakse ka elupaiganišiks (habitat niche), vaatleb nišši eelkõige kui osa abiootilisest keskkonnast\[cite: 43, 54\]. \[cite_start\]See tähendab liigi elutegevuseks vajalike abiootiliste ja biootiliste keskkonnafaktorite kogumit\[cite: 53\].

\[cite_start\]**Charles Elton (1927)** seevastu lähenes nišile funktsionaalsemalt, defineerides seda kui loomaliigi "kohta biootilises keskkonnas" ehk liigi asukohta ja suhteid teiste koosluse liikidega\[cite: 44\]. \[cite_start\]Eltoni käsitluses on nišš organismi kohastumiste kompleks abiootilisele ja biootilisele keskkonnale, esindades organismi rolli koosluses\[cite: 55\].

Nende kahe lähenemise süntees näitab, et nišš hõlmab nii seda, *milliseid tingimusi liik vajab* (Grinnell), kui ka seda, *mida liik koosluses teeb* (Elton).
...
::: callout-caution
Pange tähele, et pildiallkirjas on autorid kasutanud terminit *facilitative* positiivse mõjuga liikidevaheliste interaktsioonide katusterminina. Meie kursuse mõistes on fasilitatsioon spetsiifilisem termin - [kel meelest läinud, vaatab siit](Positiivsed_interaktsioonid.html#fasilitatsioon-ehk-soodustamine).
:::

...
Olgu siinkohal öeldud, et tegelikult ei kirjelda ei Shannoni indeks ega Gini-Simpsoni indeks tõelist mitmekesisust:
::: {.content-visible when-format="html"}
[vabatahtlikku lisalugemist mitmekesisusest](lisamaterjalid/Jost-2006-Entropy_and_diversity.pdf){style="color: gray;" target="_blank" rel="noopener noreferrer"}
:::

::: {.content-visible when-format="pdf"}
[vabatahtlikku lisalugemist mitmekesisusest](lisamaterjalid/Jost-2006-Entropy_and_diversity.pdf)
:::
- lugeda mõistlikkuse piirini.
